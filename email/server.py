...
sys.path.insert(0, "/home/claude/iris/memory-legacy")
try:
...
DEFAULT_FROM = f"Iris <iris@{DOMAIN}>"
...
if not POSTMARK_API_TOKEN:
    print("WARNING: POSTMARK_API_TOKEN not set in environment. Email sending may fail.", file=sys.stderr)
...
@mcp.tool()
def send_email(to: str, subject: str, body: str, from_addr: str = DEFAULT_FROM) -> str:
    ...
    Args:
        ...
        from_addr: Sender address (defaults to Iris <iris@[IRIS_DOMAIN]>)
    """
